...
describe("LiquidityManager", function () {
  ...
  let tokenOne = "0x6B175474E89094C44Da98b954EedeAC495271d0F";
  let tokenTwo = "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48";
  ...
  it("should create a deposit for an ERC721 token", async function () {
    // Mint a new position
    const amount0ToMint = ethers.utils.parseUnits("1",18);
    const amount1ToMint = ethers.utils.parseUnits("1",6);
    console.log("Pass 9 ",amount0ToMint,amount1ToMint);
    const tx = await liquidityManager.mintNewPosition(tokenOne,tokenTwo,amount0ToMint,amount1ToMint,100);
    console.log("Pass 10 ");
