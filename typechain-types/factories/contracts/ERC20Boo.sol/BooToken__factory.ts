...
export class BooToken__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(overrides || {}) as Promise<BooToken>;
  }
  ...
  override attach(address: string): BooToken {
    return super.attach(address) as BooToken;
  }
  override connect(signer: Signer): BooToken__factory {
    return super.connect(signer) as BooToken__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): BooTokenInterface {
    return new utils.Interface(_abi) as BooTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BooToken {
    return new Contract(address, _abi, signerOrProvider) as BooToken;
  }
}
